...
async def main_drone1():
    ...
    for matrix in MATRICES:
        pos = find_drone_position(matrix, 1)
        if pos:
            await safe_move(1, drone1, *pos, CRUISE_ALT)

async def main_drone2():
    drone2 = await connect_and_check("udp://:14542")
    await arm_takeoff(drone2, "Drone 2", CRUISE_ALT)
    for matrix in MATRICES:
        pos = find_drone_position(matrix, 2)
        if pos:
            await safe_move(2, drone2, *pos, CRUISE_ALT)
...
# Conectando ao drone em udp://:14541...
# Conectado ao drone em udp://:14541
# Verificando sensores em udp://:14541...
# Sensores prontos em udp://:14541
# [Drone 1] Armando...
# [Drone 1] Decolando para 3 m...
# [Drone 1] Definindo referência global: (47.397970799999996, 8.5461641)
# [Drone 1] Chegou ao destino.
# [Drone 1] Chegou ao destino.
# [Drone 1] Chegou ao destino.
# Conectando ao drone em udp://:14542...
# Conectado ao drone em udp://:14542
# Verificando sensores em udp://:14542...
# Sensores prontos em udp://:14542
# [Drone 2] Armando...
# [Drone 2] Decolando para 3 m...
# [Drone 2] Risco de colisão com Drone 1, ajustando altitude...
# [Drone 2] Risco de colisão com Drone 1, ajustando altitude...
# [Drone 2] Risco de colisão com Drone 1, ajustando altitude...
# [Drone 2] Risco de colisão com Drone 1, ajustando altitude...
# [Drone 2] Risco de colisão com Drone 1, ajustando altitude...
...
# Sensores prontos em udp://:14541
# [Drone 1] Pousando...
# [Drone 1] Drone pousou com sucesso.
# Conectando ao drone em udp://:14542...
# Conectado ao drone em udp://:14542
# Verificando sensores em udp://:14542...
# Sensores prontos em udp://:14542
# [Drone 2] Pousando...
# [Drone 2] Drone pousou com sucesso.
